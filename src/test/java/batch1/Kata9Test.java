...
public class Kata9Test {
    ...
    public void tests() {
        ...
        assertEquals("found the needle at position 3", Kata9.findNeedle(haystack1));
        assertEquals("found the needle at position 5", Kata9.findNeedle(haystack2));
        assertEquals("found the needle at position 30", Kata9.findNeedle(haystack3));
    }
}