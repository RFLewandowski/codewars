...
public class StringUtilsTest {
    ...
    public void fixedTests() {
        ...
        assertEquals("HELLO world", StringUtils.toAlternativeString("hello WORLD"));
        assertEquals("hEllO wOrld", StringUtils.toAlternativeString("HeLLo WoRLD"));
        assertEquals("batch0.Hello World", StringUtils.toAlternativeString(StringUtils.toAlternativeString("batch0.Hello World")));
        ...
        assertEquals("sTRINGuTILS.TOaLTERNATINGcASE", StringUtils.toAlternativeString("batch0.StringUtils.toAlternatingCase"));
    }
